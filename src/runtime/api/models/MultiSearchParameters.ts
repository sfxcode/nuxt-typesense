 ...
 */
export function instanceOfMultiSearchParameters(value: object): value is MultiSearchParameters {
    return true;
}
...
export function MultiSearchParametersToJSON(json: any): MultiSearchParameters {
    return MultiSearchParametersToJSONTyped(json, false);
}

export function MultiSearchParametersToJSONTyped(value?: MultiSearchParameters | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
