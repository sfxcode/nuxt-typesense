...
/**
 * Check if a given object implements the SearchOverride interface.
 */
export function instanceOfSearchOverride(value: object): boolean {
    let isInstance = true;
...
export function SearchOverrideFromJSON(json: any): SearchOverride {
    return SearchOverrideFromJSONTyped(json, false);
}

export function SearchOverrideFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchOverride {
...
export function SearchOverrideToJSON(value?: SearchOverride | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
